...
int main(int argc, char ** argv)
{
  ...
  // Marking the outbox as not writable does not work with HSA
  // It require mmap PROT_READ, which succeeds, but lock memory to pool
  // the fails with the read-only mapping, even if the seal is not applied
